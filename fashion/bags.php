...
/* Get only Bags from fashion table */
$sql = "SELECT * FROM fashion WHERE category = 'Bags' ORDER BY id DESC";
...
<section class="fashion-section">
    <h2 class="page-title">Bags Collection</h2>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                ...
                <div class="fashion-card">
                    <a href="fashion.php?id=<?php echo $row['id']; ?>">
                        ...
                        <p class="category"><?php echo htmlspecialchars(isset($row['category']) ? $row['category'] : 'Bags'); ?></p>
