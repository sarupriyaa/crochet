...
/* Get only Accessories from fashion table */
$sql = "SELECT * FROM fashion WHERE category = 'Accessories' ORDER BY id DESC";
...
<html>
<head>
    <title>Keychain Collection</title>
...
<section class="fashion-section">
    <h2 class="page-title">Keychain Collection</h2>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                ...
                <div class="fashion-card">
                    <a href="fashion.php?id=<?php echo $row['id']; ?>">
                        ...
                        <p class="category"><?php echo htmlspecialchars(isset($row['category']) ? $row['category'] : 'Accessories'); ?></p>
