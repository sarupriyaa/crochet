...
/* Get only Car items from decors table */
$sql = "SELECT * FROM decors WHERE category = 'Car' ORDER BY id DESC";
...
<html>
<head>
    <title>Car Decor Collection</title>
...
<section class="decor-section">
    <h2 class="page-title">Car Decor Collection</h2>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                ...
                <div class="decor-card">
                    <a href="decor.php?id=<?php echo $row['id']; ?>">
                        ...
                        <p class="category"><?php echo htmlspecialchars(isset($row['category']) ? $row['category'] : 'Car'); ?></p>
