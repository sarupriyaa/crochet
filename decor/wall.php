...
/* Get only Wall items from decors table */
$sql = "SELECT * FROM decors WHERE category = 'Wall' ORDER BY id DESC";
...
<html>
<head>
    <title>Wall Decor Collection</title>
...
<section class="decor-section">
    <h2 class="page-title">Wall Decor Collection</h2>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                ...
                <div class="decor-card">
                    <a href="decor.php?id=<?php echo $row['id']; ?>">
                        ...
                        <p class="category"><?php echo htmlspecialchars(isset($row['category']) ? $row['category'] : 'Wall'); ?></p>
